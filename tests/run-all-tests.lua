...
print("")
local bugfix_success = run_test_file("test-bug-fixes.lua")
print("")
local nilsafety_success = run_test_file("test-nil-safety.lua")
...
print("bug fix regression:  " .. (bugfix_success and "PASS" or "FAIL"))
print("nil safety tests:    " .. (nilsafety_success and "PASS" or "FAIL"))
print("")
